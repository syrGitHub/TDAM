...
from keras.layers import GRU, TimeDistributed,Lambda,Multiply,GlobalAveragePooling1D,Input,Reshape,Softmax,RepeatVector,LSTM
...
def build_model(X_train):
    ...
    final = LSTM(32, activation='tanh', return_sequences=False)(inputs)
    final = Dense(1)(final)
...
if __name__ == '__main__':
    ...
    # CUDA_VISIBLE_DEVICES="" PYTHONHASHSEED=0 python -u only_LSTM.py | tee ./only_LSTM_96__24
